...
export default function Header() {
    ...
    const deleteCart=(i)=>{
        axios.post(`http://localhost:3001/deleteCart/${id}`,{item_name:cartData[i].item_name})
        .then((res)=>{
            ...
            <header>
                <div className='header'>
                    ...
                    <div className="icons">
                        ...
                        <div className="cart" onClick={() => { setcarttrue(!carttrue); setnavtrue(false); setdroptrue(false); setinputtrue(false);getCartData()}}><BsFillCartFill /></div>
                    ...
                    <div className={droptrue ? 'drop-bar drop-bar-active' : 'drop-bar drop-bar-non-active'} >
                        ...
                        <div className="user-buttons">
                            ...
                            <button className='update' onClick={() => navigate('/update/'+id)}>Update Profile</button>
